<?php $this->setSiteTitle($this->news->title); ?>
<?php $this->start('head'); ?>
<!-- main css -->
          ...
          <div class="container">
              <div class="banner_content text-center">
                  ...
                  <div class="page_link">
                      ...
                      <a href="<?=PROOT?>news">News Single</a>
                  </div>
              </div>
          </div>
      </div>
			...
			<div class="container">
							...
							<div class="col-lg-8 posts-list">
									<div class="single-post">
													<div class="feature-img">
															<img class="img-fluid" src="<?=PROOT.$this->news->photo;?>" alt="">
													</div>
                              ...
                              <ul class="blog-info-link mt-3 mb-4">
                                ...
                                <li><a href="#"><i class="ti-comments"></i> 03 Comments</a></li>
													...
													<p class="excert" style="font-size:18px;word-spacing:10px"><?=$this->news->body;?></p>
											</div>
                  </div>
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                <div class="thumb">
                                    <a href="#">
                                        <img class="img-fluid" src="<?=PROOT?>img/blog/prev.jpg" alt="">
                                    </a>
                                </div>
                                <div class="arrow">
                                    <a href="#">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                ...
                                <div class="thumb">
                                    <a href="#">
                                        <img class="img-fluid" src="<?=PROOT?>img/blog/next.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                  ...
                  <div class="blog-author">
                    <div class="media align-items-center">
                      <img src="<?=PROOT?>img/blog/author.png" alt="">
                      <div class="media-body">
                        ...
                        <div class="single-comment justify-content-between d-flex">
                          <div class="user justify-content-between d-flex">
                              <div class="thumb">
                                  <img src="<?=PROOT?>img/blog/c1.png" alt="">
                              </div>
                              <div class="desc">
                                  <p class="comment">
                          ...
                          <div class="single-comment justify-content-between d-flex">
                              <div class="user justify-content-between d-flex">
                                  <div class="thumb">
                                      <img src="<?=PROOT?>img/blog/c2.png" alt="">
                                  </div>
                                  <div class="desc">
                                      <p class="comment">
                                        Multiply sea night grass fourth day sea lesser rule open subdue female fill which them Blessed, give fill lesser bearing multiply sea night grass fourth day sea lesser 
                          ...
                          <div class="single-comment justify-content-between d-flex">
                              <div class="user justify-content-between d-flex">
                                  <div class="thumb">
                                      <img src="<?=PROOT?>img/blog/c3.png" alt="">
                                  </div>
                                  <div class="desc">
                                      <p class="comment">
                                        Multiply sea night grass fourth day sea lesser rule open subdue female fill which them Blessed, give fill lesser bearing multiply sea night grass fourth day sea lesser 
